...
export function PromoBanner({ locationLabel }: PromoBannerProps) {
  return (
    <section className="relative overflow-hidden rounded-2xl border border-[#ececec] bg-[linear-gradient(115deg,#fff5ef_0%,#ffe4d4_55%,#ffb78f_100%)]">
      <div className="pointer-events-none absolute inset-y-0 right-0 w-1/2 opacity-70">
        <svg aria-hidden="true" viewBox="0 0 400 300" className="h-full w-full" preserveAspectRatio="xMaxYMid slice">
          ...
          <g transform="translate(220 100)" opacity="0.85">
            ...
            <ellipse cx="80" cy="48" rx="40" ry="20" fill="#f75d36" opacity="0.18" />
            <ellipse cx="30" cy="48" rx="30" ry="16" fill="#f75d36" opacity="0.28" />
          </g>
          <g transform="translate(120 50)" opacity="0.6">
            <circle cx="30" cy="30" r="18" fill="#f75d36" opacity="0.35" />
            <circle cx="60" cy="40" r="24" fill="#f75d36" opacity="0.22" />
          </g>
        </svg>
      </div>

      <div className="relative grid gap-4 px-8 py-10 sm:px-12 sm:py-14">
        <span className="inline-flex w-fit items-center gap-2 rounded-full bg-white/80 px-3 py-1 text-[0.72rem] font-semibold uppercase tracking-[0.18em] text-[#9f3a20] backdrop-blur">
        ...
        <h1 className="max-w-[16ch] text-[clamp(2rem,5vw,3.4rem)] font-semibold leading-[0.96] tracking-[-0.04em] text-[#1a1a1a]">
          Rescue good food.
          <br />
          Save up to <span className="italic text-[#f75d36]">70% off.</span>
        </h1>
        ...
        <div className="mt-1 flex flex-wrap items-center gap-3">
          <a
            href="#deals-for-you"
            className="inline-flex items-center gap-2 rounded-full bg-[#1a1a1a] px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#f75d36]"
          >
            Shop deals
          ...
          <a
            href="#ending-soon"
            className="inline-flex items-center gap-2 rounded-full border border-[#1a1a1a]/15 bg-white px-5 py-3 text-sm font-semibold text-[#1a1a1a] transition-colors hover:border-[#f75d36] hover:text-[#f75d36]"
          >
            Ending soon
          </a>
        </div>
